          ...
          <tr>
            <td style="background-color: #f8fafc; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0; border-top: none; padding: 20px 36px; text-align: center;">
              <p style="margin: 0 0 4px; font-size: 12px; color: #94a3b8;">
                <strong style="color: #193736;">Prospecto</strong> · Plateforme d'exécution commerciale
              </p>
              <p style="margin: 0; font-size: 11px; color: #cbd5e1; line-height: 1.5;">
                Vous recevez cet email car vous êtes client sur la plateforme Prospecto.<br/>
    ...
    <tr>
      <td align="center">
        <table cellpadding="0" cellspacing="0" width="600" style="max-width: 600px; width: 100%;">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #0f172a 0%, #1e3a5f 100%); border-radius: 12px 12px 0 0; padding: 28px 36px; text-align: center;">
              <p style="margin: 0; font-size: 22px; font-weight: 800; color: #FBFAF7; letter-spacing: -0.03em;">Prospecto</p>
          ...
          <tr>
            <td style="background-color: #f8fafc; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0; border-top: none; padding: 20px 36px; text-align: center;">
              <p style="margin: 0 0 4px; font-size: 12px; color: #637875;"><strong style="color: #193736;">Prospecto</strong> · Plateforme d'exécution commerciale</p>
              <p style="margin: 0; font-size: 11px; color: #7B8984; line-height: 1.5;">Vous recevez cet email car vous êtes client sur la plateforme Prospecto.<br/>Pour toute question, contactez votre chargé de compte.</p>
            </td>
          </tr>
