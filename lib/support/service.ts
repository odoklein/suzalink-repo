...
export async function notifyClientByEmailIfEnabled(
    ...
    await sendTransactionalEmail({
        to: clientUser.email,
        subject: `Nouvelle réponse de l'équipe support Prospecto`,
        html: `
<div style="font-family:sans-serif;max-width:520px;margin:0 auto;color:#1f2b1f">
  ...
  <p style="font-size:15px">L'équipe support Prospecto vous a répondu :</p>
