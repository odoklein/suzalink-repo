    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
          {
            ...
            value: process.env.CSP || "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' http://analytics-umami-250e8c-173-212-225-37.sslip.io; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self'; connect-src 'self' https: http://analytics-umami-250e8c-173-212-225-37.sslip.io; frame-src 'self' https://cal.com https://*.cal.com https://cal.eu https://*.cal.eu; worker-src 'self' blob:; frame-ancestors 'none'; base-uri 'self'; form-action 'self';",
          },
