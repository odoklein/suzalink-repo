...
export default function SDRProjectDetailPage() {
...
function ProjectSettings({ project, onUpdate, projectsBase }: { project: ProjectData; onUpdate: () => void; projectsBase: string }) {
